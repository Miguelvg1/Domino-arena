...
function style(){if(document.querySelector('#annSpecialStyle'))return;const s=document.createElement('style');s.id='annSpecialStyle';s.textContent=`
.specialGrid{grid-template-columns:repeat(3,1fr)!important;gap:7px!important}
.specialGrid .special{min-height:68px!important;padding:9px 5px!important;border-radius:14px!important;font-size:11px!important;line-height:1.15!important}
.specialGrid .special b{font-size:18px!important;margin-top:4px!important}
.special.extraSpecial{background:linear-gradient(135deg,#0f5f68,#2563eb)}
.special.extraSpecial[data-extra-special="capicua"]{background:linear-gradient(135deg,#166534,#22c55e)}
.special.extraSpecial[data-extra-special="dos_carotas"]{background:linear-gradient(135deg,#7c2d12,#f97316)}
@media(max-width:560px){.specialGrid{grid-template-columns:repeat(3,1fr)!important}.specialGrid .special{min-height:64px!important;padding:8px 4px!important;font-size:10px!important}.specialGrid .special b{font-size:17px!important}}
